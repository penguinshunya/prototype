...
export const Article20210216: React.VFC<Props> = memo(() => {
  return (
    <ArticleContent>
      ...
      <P>
        Googleアカウントは一個人ではなく、グループやサービスが所持することがある。このようなGoogleアカウントのIDは、見た目はメールアドレスと形式だがメールボックスは存在しない。そして、グループが所持するGoogleアカウントに個人の所持するGoogleアカウントを複数紐付けることができる。こうすることで、集団に対してのロールの割り当て回数が、グループの所持するGoogleアカウントへのロールの割り当て1回で済ませることができる。
      </P>
      <Divider />
      <P>
